...
A timeout can leave the outcome of an external request unknown.

## Practical value

Distinguishing an intended action from a confirmed result helps explain duplicate-action risk.
